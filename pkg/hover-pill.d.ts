...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h178054044f0bfe10: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0c3bdbcbf628d7e6: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h20a29c1e5c747cc8: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h0786cf901b020bec: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hf3872a063573e861: (a: number, b: number, c: number) => void;
